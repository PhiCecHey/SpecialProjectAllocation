...
public class Config {
    ...
    public class ProjectAdministration {
        ...
        public static final String projAdminVarOneStudent = "one student";
        ...
        public static final String projAdminDelimFixedStuds = ";";
        public static final String projAdminDelimFixedStudsNameImma = ",";
        public static final char quotes = '\"';
    }

    public class Constraints {
        // Gurobi constraint values
        public static final int constrMaxNumProjectsPerStudent = 1;
        public static final int constrMinNumProjectsPerStudent = 1;
    }
}
